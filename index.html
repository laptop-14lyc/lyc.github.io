	...
	<body>
		...
		<body>
			...
			<h2>
				<span id="text">
					<li>
						<a href="#intro">子路、曾皙、冉有、公西华侍坐(点此查看原文）</a>
					</li>
				</span>
			</h2>
			<p>________________________________</p>
			<p onclick="scrollToBottom()" style="color:red">前半部分为原文，后半部分为音频{快速导航至“顺序循环播放”请点此}</p>
			<h6>点击朝代刷新并回到顶部</h6>
			<p>________________________________</p>
			<p>目录</p>
			<head>
			...
			<body>
				...
				<body style="height:2000px;">
					...
					<p>__________________________________________</P>
					<p style="color:green">以下为顺序播放模块</p>
				...
				<audio src="https://ziyuan.guwendao.net/song/make/736e296de7fd.mp3" controls id="audio" autoplay data-num="0">
				</audio>
				<br>
				...
				<select name="" id="select" multiple>
					<option value="0" selected>子路、曾皙、冉有、公西华侍坐</option>
					<option value="1">齐桓晋文之事</option>
					<option value="2">庖丁解牛(庄周)</option>
					<option value="3">烛之武退秦师(左丘明)</option>
					<option value="4">鸿门宴(司马迁)</option>
					<option value="5">谏逐客书(李斯)</option>
					<option value="6">与妻书(林觉民)</option>
					<option value="7">促织(蒲松龄)</option>
					<option value="8">谏太宗十思疏(魏征)</option>
					<option value="9">答司马谏议书(王安石)</option>
					<option value="10">阿房宫赋(杜牧)</option>
					<option value="11">六国论(苏洵)</option>
					<option value="12">滕王阁序(王勃)</option>
					<option value="13">枯树赋(庾信)</option>
					<option value="14">春江花月夜(张若虚)</option>
					<option value="15">琵琶行(白居易)</option>
					<option value="16">李凭箜篌引(李贺)</option>
				</select>
				<script>let text = document.getElementById("text");
					...
					console.log(options);
					let sings = [{
						src: "https://ziyuan.guwendao.net/song/make/736e296de7fd.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/4a849bab9912.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/8def13da8f71.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/5472fd05f090.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/qionghua/7cec0d1b3a86.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/2a6f10fb5dec.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/qionghua/7de576f0313f.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/qionghua/95f1b5461664.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/3827a21544f0.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/make/b09aa5c9b747.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/chenlang/0456af8aceec.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/qionghua/077582755824.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/jiangweiwei/ce802de625e5.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/yiyesheng/205936e31c75.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/jiangweiwei/3aed26d1fa99.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/yiyesheng/0581b0ba8bb4.mp3"
					},
					{
						src: "https://ziyuan.guwendao.net/song/chenlang/77b08ab3153f.mp3"
					}];
					function srlected() {
